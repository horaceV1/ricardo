      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            ...
            {/* Submissions Management Panel Link */}
            {(user.roles.includes('administrator') || user.roles.includes('tecnico')) && (
              <div className="bg-gradient-to-br from-[#009999] to-[#007a7a] rounded-2xl shadow-lg p-6 text-white">
                <h3 className="text-lg font-bold mb-2">Gestão de Submissões</h3>
