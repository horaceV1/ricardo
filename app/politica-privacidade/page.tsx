        ...
        <div className="prose prose-lg max-w-none text-gray-700">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6">
              <li>nome; apelido; empresa ou entidade; cargo/função; endereço de email; número de telefone; morada; NIF, quando necessário.</li>
            </ul>

            <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-2">3.2. Dados de conta de utilizador</h3>
            <ul className="list-disc pl-6">
              <li>nome de utilizador; credenciais de autenticação; histórico de acessos; preferências da conta; estado da conta; dados de recuperação de acesso.</li>
            </ul>

            <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-2">3.3. Dados comerciais e de faturação</h3>
            <ul className="list-disc pl-6">
              <li>dados da encomenda; histórico de compras; inscrições em formações; morada de faturação; NIF; documentos contabilísticos e fiscais; informação necessária para emissão de faturas e gestão administrativa.</li>
            </ul>

            <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-2">3.4. Dados de pagamento</h3>
            <ul className="list-disc pl-6">
              <li>identificador da transação; método de pagamento selecionado; estado do pagamento; dados de reconciliação financeira; informação comunicada por prestadores de serviços de pagamento.</li>
            </ul>

            <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-2">3.5. Dados de navegação e utilização</h3>
            <ul className="list-disc pl-6">
              <li>endereço IP; tipo de dispositivo; sistema operativo; navegador; idioma; páginas visitadas; datas e horas de acesso; origem do tráfego; eventos e interações no website; cookies e identificadores online.</li>
            </ul>

            <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-2">3.6. Dados de marketing e comunicação</h3>
            <ul className="list-disc pl-6">
              <li>preferências de comunicação; registos de consentimento; subscrição de newsletters; taxa de abertura, cliques e interações com campanhas; segmentação básica de comunicações.</li>
            </ul>
